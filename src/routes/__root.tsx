...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hugo Varennes — Présidentielle 2027" },
      { name: "description", content: "Hugo Varennes, candidat à l'élection présidentielle française de 2027. Pour la France de demain : justice, souveraineté, écologie." },
      { property: "og:title", content: "Hugo Varennes — Présidentielle 2027" },
      { property: "og:description", content: "Hugo Varennes, candidat à l'élection présidentielle française de 2027. Pour la France de demain : justice, souveraineté, écologie." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Hugo Varennes 2027" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;0,9..144,700;1,9..144,400;1,9..144,500;1,9..144,600;1,9..144,700&family=Inter:wght@400;500;600;700&display=swap" },
    ],
  }),
