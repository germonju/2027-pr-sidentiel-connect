      ...
      <div className="container-narrow py-14 grid gap-10 md:grid-cols-12">
        ...
        <div className="md:col-span-5">
          ...
          <div className="mt-5 flex gap-3">
            {[
              { label: "X (Twitter)", href: "https://www.instagram.com/hugovarennes2027", icon: (
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              )},
              { label: "Instagram", href: "https://www.instagram.com/hugovarennes2027", icon: (
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              { label: "YouTube", href: "https://www.instagram.com/hugovarennes2027", icon: (
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
